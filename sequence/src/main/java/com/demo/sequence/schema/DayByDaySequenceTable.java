...
public class DayByDaySequenceTable extends GlobalSequenceTable implements Serializable {
	 ...
	 * 数据库表名称
	 */
	private String tableName = "sequence_daybyday";
	/**
	 * 键字段名
	 */
	 ...
	 * 创建日字段名
	 */
	private String createDayName = "create_day";
	/**
	 * 创建时间字段名
	 */
	...
	public String getCreateDayName() {
		return createDayName;
	}

	public void setCreateDayName(String createDayName) {
		this.createDayName = createDayName;
	}
